 ...
 */
public class PluginResource extends CustomResource implements Namespaced {

    private PluginResourceSpec spec;
    private PluginResourceStatus status;

    public PluginResourceStatus getStatus() {
        return status;
    }

    public void setStatus(PluginResourceStatus status) {
        this.status = status;
    }
    ...
    public PluginResourceSpec getSpec() {
        return spec;
    }

    public void setSpec(PluginResourceSpec spec) {
        this.spec = spec;
    }
