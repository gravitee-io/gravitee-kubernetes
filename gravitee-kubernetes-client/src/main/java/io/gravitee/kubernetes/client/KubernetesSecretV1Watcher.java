 ...
 */
@Component
public class KubernetesSecretV1Watcher extends AbstractKubernetesResourceWatcher {

    @Autowired
    protected KubernetesSecretV1Watcher(Vertx vertx, KubernetesClient kubernetesClient, KubernetesConfig kubernetesConfig) {
