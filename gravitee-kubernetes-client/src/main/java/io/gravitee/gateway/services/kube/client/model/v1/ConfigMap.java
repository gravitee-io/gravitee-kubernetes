...
public class ConfigMap implements Serializable {
    ...
    private io.gravitee.gateway.services.kube.client.model.v1.ObjectMeta metadata;
    ...
    public ConfigMap(
        ...
        Boolean immutable,
        String kind,
        io.gravitee.gateway.services.kube.client.model.v1.ObjectMeta metadata
    ) {
        super();
    ...
    public io.gravitee.gateway.services.kube.client.model.v1.ObjectMeta getMetadata() {
        return metadata;
    }
